...
public class AlunoDAO {
    ...
    public List<Aluno> list() {
        //Prepara lista que retornará alunos após consultar o banco de dados
        ...
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            //Cria um objeto aluno e guardar na lista de alunos
            while(rs.next()){
                int id = rs.getInt("id");
    ...
    public void create(Aluno aluno) {
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            //Prepara SQL para inserção de dados do aluno
    ...
    public void delete(int id) {
        try (Connection conn = ConnectionFactory.getConnection()) {
            ...
            //Prepara SQL para deletar uma linha.
